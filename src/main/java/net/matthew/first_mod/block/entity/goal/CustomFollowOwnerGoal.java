...
public class CustomFollowOwnerGoal extends Goal {
    ...
    public CustomFollowOwnerGoal(TamableAnimal pTamable, double pSpeedModifier, float pStartDistance, float pStopDistance, boolean pCanFly, CatEntity cat) {
    ...
    public boolean canUse() {
        //System.out.println("GOAL CLASS" + this.catEntity.following);
