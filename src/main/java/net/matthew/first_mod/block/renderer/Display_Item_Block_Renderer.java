...
import net.matthew.first_mod.block.custom.Display_Item_Block;
...
public class Display_Item_Block_Renderer implements BlockEntityRenderer<DisplayItemBlockEntity> {

    public Display_Item_Block_Renderer(BlockEntityRendererProvider.Context context) {

    }

    @Override
    public void render(DisplayItemBlockEntity blockEntity, float partialTicks, PoseStack poseStack, MultiBufferSource bufferSource, int combinedLight, int combinedOverlay) {
        ...
        if (!itemStack.isEmpty()) {
            ...
            if (!(itemStack.getItem() instanceof BlockItem)) {
                ...
                poseStack.translate(0.5D, 0.1D, 0.5D); // Centered horizontally, lowered vertically
