...
import net.matthew.first_mod.block.custom.Display_Item_Block_Plus1;
...
public class Display_Item_Block_Renderer_Plus1 implements BlockEntityRenderer<DisplayItemBlockEntityPlus1> {

    public Display_Item_Block_Renderer_Plus1(BlockEntityRendererProvider.Context context) {

    }

    @Override
    public void render(DisplayItemBlockEntityPlus1 blockEntity, float partialTicks, PoseStack poseStack, MultiBufferSource bufferSource, int combinedLight, int combinedOverlay) {
        ...
        if (!itemStack.isEmpty()) {
            ...
            if (!(itemStack.getItem() instanceof BlockItem)) {
                ...
                poseStack.translate(0.5D, 0.15D, 0.5D); // Centered horizontally, lowered vertically
                ...
                // Adjust the translation to move the item into the correct position
                poseStack.translate(0.5D, 0.55D, 0.5D); // Centered horizontally, lowered vertically
